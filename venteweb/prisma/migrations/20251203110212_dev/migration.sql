...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('Post', 'Reminder', 'RequestCollaboration', 'RequestAnswered', 'Participation', 'Rating', 'Invitation', 'InvitationAnswered', 'Follow');
...
CREATE TABLE "Event" (
    ...
    "poster" TEXT NOT NULL DEFAULT 'https://res.cloudinary.com/doqla97yu/image/upload/fl_preserve_transparency/v1760896293/events/default_d16vth.jpg?_s=public-apps',
    "name" TEXT NOT NULL,
    "categories" "Category"[],
