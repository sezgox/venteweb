...
@Module({
  ...
  providers: [UserService, PrismaService, UserRepository, UserScheduler, EventRepository, JwtService, InvitationsService, ParticipationRepository, CloudinaryService],
})
